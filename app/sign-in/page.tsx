...
import { signInWithOAuth, signInWithPassword, signOutClient, getClientProfile } from "@/lib/auth/client";
...
function SignInContent() {
  ...
  return (
    <div 
      ...
      style={{ background: "#121214", padding: "clamp(32px, 8vw, 48px) clamp(20px, 6vw, 40px)", minHeight: "400px", display: "flex", flexDirection: "column", justifyContent: "center" }}
    >
      {profile === undefined ? (
        ...
        <>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", marginBottom: "32px" }}>
            <button 
              ...
              disabled={isLoading}
              className="flex items-center justify-center gap-3 w-full bg-[#1c1c1f] hover:bg-[#252529] text-white text-[14px] font-medium rounded-lg border border-[rgba(255,255,255,0.05)] transition-colors cursor-pointer disabled:opacity-50"
              style={{ padding: "14px" }}
            >
            ...
            <button 
              ...
              disabled={isLoading}
              className="flex items-center justify-center gap-3 w-full bg-white hover:bg-gray-100 text-gray-900 text-[14px] font-medium rounded-lg transition-colors cursor-pointer disabled:opacity-50"
              style={{ padding: "14px" }}
            >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "32px" }}>
            ...
            <span className="text-[11px] font-medium text-[var(--text-secondary)] tracking-wider">OR SIGN IN WITH EMAIL</span>
            <div className="flex-1 h-[1px] bg-[rgba(255,255,255,0.06)]" />
          </div>
          ...
          <form onSubmit={handleEmailSignIn} style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            ...
            {/* Password Field */}
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <label className="text-[13px] text-gray-300 font-medium ml-1">Password</label>
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="w-full bg-[var(--orange)] hover:bg-[var(--orange-dark)] text-white text-[15px] font-semibold rounded-xl transition-colors shadow-lg shadow-orange-500/10 cursor-pointer disabled:opacity-50"
          ...
          <div style={{ textAlign: "center", marginTop: "32px" }}>
            <p className="text-[13.5px] text-[var(--text-secondary)]">
              ...
              <Link href="/sign-up" className="text-[var(--orange)] hover:text-[var(--orange-dark)] font-medium transition-colors">
                Sign up
              </Link>
            </p>
          </div>
