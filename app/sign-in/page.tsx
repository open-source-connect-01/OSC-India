          ...
          {profile === undefined ? (
            ...
            <>
              ...
              <form action={handleEmailSignIn} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                ...
                <button 
                  type="submit"
                  className="w-full bg-[var(--orange)] hover:bg-[var(--orange-dark)] text-white text-[15px] font-semibold rounded-xl transition-colors shadow-lg shadow-orange-500/10 cursor-pointer"
