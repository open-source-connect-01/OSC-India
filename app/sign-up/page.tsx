...
export default function SignUpPage() {
  ...
  const handleGithubSignUp = async () => {
    try {
      ...
      setErrorMessage(err.message || "Failed to initiate GitHub sign-up");
      setIsLoading(false);
    }
  };
        ...
        >
          {profile === undefined ? (
            ...
            <>
              ...
              {successMessage && (
                <div style={{ background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.3)", color: "#22c55e", padding: "10px 14px", borderRadius: "10px", fontSize: "13px", marginBottom: "20px" }}>
                  {successMessage}
                </div>
              )}

              {/* Form */}
              <form onSubmit={handleEmailSignUp} style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                {/* Full Name Field */}
