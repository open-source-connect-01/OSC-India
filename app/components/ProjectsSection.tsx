  ...
  const projects = [
    {
      ...
      dotColor: "#ec4899",
      accentColor: "#ec4899",
      desc: "AI-powered women safety solution providing emergency assistance, SOS alerts, and location sharing.",
      stars: "0",
      forks: "0",
    },
    {
      ...
      dotColor: "#f59e0b",
      accentColor: "#f59e0b",
      desc: "AI-powered Chrome Extension that enhances prompts for ChatGPT, Claude, and Gemini with persona-based engineering.",
      stars: "0",
      forks: "0",
    },
    {
      ...
      dotColor: "#06b6d4",
      accentColor: "#06b6d4",
      desc: "Network monitoring and security operations dashboard providing real-time packet/traffic analytics and alerts.",
      stars: "0",
      forks: "0",
    },
    {
      ...
      dotColor: "#8b5cf6",
      accentColor: "#8b5cf6",
      desc: "Adaptive, intelligent connectivity combining decentralized networks, eSIMs, and WireGuard VPN technologies.",
      stars: "0",
      forks: "0",
    },
    {
      ...
      dotColor: "#10b981",
      accentColor: "#10b981",
      desc: "An intelligent proactive agent system querying users about pending schedule tasks, reminders, and daily commitments.",
      stars: "0",
      forks: "0",
    },
    {
      ...
      dotColor: "#6366f1",
      accentColor: "#6366f1",
      desc: "Multi-agent intelligence and research workspace that orchestrates specialized AI agents to produce verified reports.",
      stars: "0",
      forks: "0",
    },
  ];
